...
from paintcanvas.geometry import grow_rect, get_shape_rect, ensure_positive_rect
from paintcanvas.shapes import Text
from paintcanvas.tools.shapetool import ShapeTool
