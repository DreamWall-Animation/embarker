...
from paintcanvas.tools.movetool import shift_element, shift_selection_content
...
class TransformTool(NavigationTool):
    ...
    def mousePressEvent(self, event):
        ...
        if rects and selection_rect:
            self.reference_rect = selection_rect
        ...
        if selection_rect and selection_rect.contains(event.pos()):
            self.action = 'move'
    ...
    def mouseMoveEvent(self, event):
        ...
        if self.action in ('topleft', 'topright', 'bottomleft', 'bottomright'):
            ...
            resize_selection(
                self.selection, self.reference_rect, rect, self.viewportmapper)
...
def resize_selection(selection, reference_rect, rect, viewportmapper):
