...
def get_images_rects(baseimage, stackimages, layout=0):
    """
    layout: CanvasModel.GRID | STACKED | HORIZONTAL | VERTICAL
    """
...
def ensure_positive_rect(rect):
    # Ensure handle rect is positive after mapping. NDC or reverse
    # coordinates system, can return a rect
    if rect.width() < 0:
        width = abs(rect.height())
